...
- **Command**: Which command to use (prefer: /adapt, /polish, /quieter, /delight, /arrange, /onboard, /audit, /typeset, /colorize, /distill, /clarify, /optimize, /animate, /harden, /bolder, /normalize, /critique, /overdrive, /extract — or other installed skills you're sure exist)
